...
import pandas as pd
import os
from leaveoneout_reweight_Moudle import *
from balancedataset import *
from collections import Counter
def leaveoneout_reweight(name1,yingshe1,chooselevel1,choose_featuretop1,dongzuo1,class_w):
    name=name1
    yingshe=yingshe1
    ...
    for i in range(0, trun):
        ...
        peopleacc, peoplelabel, precision_pre_people, F1SCORE_pre_people, recall_pre_people, levelacc, level_F1, level_recall, level_precison, people_result_all, featureimp, trueall, preall = leave_subject_out(
            ...
            subject_id, features, label, dongzuo, trueall, preall,class_w)
