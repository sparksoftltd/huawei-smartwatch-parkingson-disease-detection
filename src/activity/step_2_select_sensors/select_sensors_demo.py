...
def select_data(column_names, data_dir_path, data_file_name, feature_name_dir_path, feature_name_file_name ):
    ...
    output_dir_path = r'../../../output/activity/step_2_select_sensors'
...
if __name__ == '__main__':
    data_dir_path = '../../../output/activity/step_1_feature_extraction'
    data_file_name = 'wristr_acc_gyro_mag_feature_label.csv'
    feature_name_dir_path = '../../../input/activity/step_1_feature_extraction/raw/'
    ...
    select_data(
        ...
        feature_name_dir_path=feature_name_dir_path,
