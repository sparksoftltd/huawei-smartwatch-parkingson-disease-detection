...
def FeatureExtractWithProcess1(pd_num, activity_num, data_path, side, fea_column, window_size, overlapping_rate,
                              frequency):
    Feature = pd.DataFrame()
    for pdn in range(1, pd_num, 1):
        for acn in range(1, activity_num, 1):
