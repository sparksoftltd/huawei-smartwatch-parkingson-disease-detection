...
def choose_best_parameter(X_train_list, y_train_list, X_val_list, y_val_list, parameter_list):
    ...
    for parameter in parameter_list:
        ...
        for i in range(folder_num):
            my_model = LogisticRegression(penalty='l1', C=parameter,  solver='saga', multi_class='ovr',
                                          max_iter=3000)
...
for activity_idx in activity_idx_list:
    ...
    third_layer_dictionary = 'LogisticR_L1'
    ...
    for i in range(repetition_num):
        ...
        my_model = LogisticRegression(penalty='l1', C=best_parameter, solver='saga', multi_class='ovr',
                                      max_iter=3000)
...
save_path = final_path + 'LogisticR_L1.csv'  # 存储路径
